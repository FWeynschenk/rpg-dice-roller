  ...
  describe('Run', () => {
    ...
    describe('No compare point', () => {
      test('all rolls are multiplied by factor', () => {
        ...
        expect(modifiedResults[0].modifierFlags).toEqual('mul');
        ...
        expect(modifiedResults[1].modifierFlags).toEqual('mul');
        ...
        expect(modifiedResults[2].modifierFlags).toEqual('mul');
        ...
        expect(modifiedResults[3].modifierFlags).toEqual('mul');
        ...
        expect(modifiedResults[4].modifierFlags).toEqual('mul');
